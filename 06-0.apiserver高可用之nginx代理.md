...
stream {
    upstream backend {
        ...
        server 192.168.1.88:6443          max_fails=3 fail_timeout=30s;
        server 192.168.1.187:6443         max_fails=3 fail_timeout=30s;
        server 192.168.1.176:6443        max_fails=3 fail_timeout=30s;
    }
